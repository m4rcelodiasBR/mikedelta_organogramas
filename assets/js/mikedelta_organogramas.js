    ...
    attach: function (context, settings) {
      once('initOrganograma', '.organograma-wrapper', context).forEach(function (element) {
        ...
        for (var i = 0; i < dadosMembros.length; i++) {
          ...
          var corSubtexto = (corTexto === '#000000') ? 'rgba(0,0,0,0.7)' : 'rgba(255,255,255,0.7)';
          var corBordaInterna = (corTexto === '#000000') ? 'rgba(0,0,0,0.1)' : 'rgba(255,255,255,0.2)';
          ...
          var htmlCartao = `
            <div class="md-cartao-inner" style="background: linear-gradient(135deg, ${m.cor_principal}, ${m.cor_secundaria}); color: ${corTexto};">
              ...
              <div class="md-cartao-dados">
                ...
                <div class="md-cartao-nome" title="${m.titulo_cargo} ${m.nome_pessoa}">${m.titulo_cargo} ${m.nome_pessoa}</div>
